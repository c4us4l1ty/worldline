...
- [x] **MVP-5 — Boot/home-page recovery + settings identity flow.** (Closed 2026-09-18: `c31b9d3` — `BootError` screen, boot routes to Home/Canvas directly, identity unlocked via Settings, `identity_status` signal shared across drawer/canvas/settings, mock shim mirrors shell sync/auth shapes.)
